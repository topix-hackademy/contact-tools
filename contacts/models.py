...
class Company(models.Model):
    ...
    company_email = models.EmailField('Company general email', max_length=200, null=False, unique=False, default="")
    company_certified_email = models.EmailField('Company certified email', max_length=200, null=False, unique=False, default="")
