...
class Company(models.Model):
    ...
    company_vat_number = models.CharField('VAT Number', null=True, blank=True, unique=True, max_length=30)
    company_tax_code = models.CharField('Tax Code', null=True, blank=True, unique=True, max_length=30)
