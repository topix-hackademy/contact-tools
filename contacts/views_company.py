...
def get_company_freesearch(request, searchstring, format=None):
    ...
    try:
        companies = Company.objects
            .filter( company_name__icontains=searchstring )
            .filter( company_short_name__icontains=searchstring )
            .filter( company_business_name__icontains=searchstring )
            .filter( company_website__icontains=searchstring )
            .filter( company_notes__icontains=searchstring ).all()
